    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper" style="padding-top: 75px !important;">
            ...
            <?php
                ...
                if(isset($_POST['themtintuc'])){ // check phuong thuc POST có tồn tại không và $_POST['themdanhmuc'] có tồn tại k (themdanhmuc là cái name ở nút button Xác nhận)
                    ...
                    if($file_tin_tuc && $tieu_de_tin_tuc && $sapo_tin_tuc && $noi_dung_tin_tuc){
                        ...
                        if(move_uploaded_file($tmp_tin_tuc,$path)){
                            $insert = "INSERT INTO `tintuc` VALUES ('','$anh_tin_tuc','$tieu_de_tin_tuc','$sapo_tin_tuc','$noi_dung_tin_tuc',0,$id_danh_muc,$tin_nong)"; //truy van them danh muc
                        ...
                        <div class="col-md-9 m-auto grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- a sẽ thêm tin tức thông qua form với phương thức là POST (gửi dữ liệu lên server), enctype="multipart/form-data": giúp người dùng có thể truyền file phương tiện -->
                                    <form class="forms-sample" method="POST" enctype="multipart/form-data"> 
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_danh_muc" id="" class="form-select" require>
                                                        ...
                                                        ?>
                                                        <option value="<?=$rowDanhMuc['id_danh_muc']?>"><?=$rowDanhMuc['ten_danh_muc']?></option>
                                                        <?php
                                                            }
                                                        ?>
                                                    </select>
                                        ...
                                        <button type="submit" class="btn btn-primary me-2" name="themtintuc">Xác nhận</button>
                                    </form>
                                </div>
                            </div>
                        </div>

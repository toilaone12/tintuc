            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <?php $hours = date('H'); ?>
                        <h1 class="welcome-text"><?= $hours < 24 && $hours >= 18 ? 'Chào buổi tối' : ($hours < 18 && $hours >= 12 ? 'Chào buổi chiều' : 'Chào buổi sáng') ?>, <span class="text-black fw-bold">John Doe</span></h1>
                    </li>
                </ul>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-category">Phần danh mục</li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="?act=danhsachdanhmuc">Danh sách danh mục</a></li>
                            </ul>
                        </div>
                    </li>
                                        ...
                                        <div class="d-flex">
                                            <form action="?act=timkiemdanhmuc" method="post">
                                                <div class="form-group d-flex justify-content-end">
                                                    <input type="text" name="keyword" placeholder="Tìm kiêm" id="" class="form-control w-50 me-1">

                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-9 m-auto grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <a href="?act=themdanhmuc" class="btn btn-success px-3 py-2 mb-3">Thêm tài khoản</a>
                                    ...
                                    <?php
                                        $sql = "SELECT * FROM quantri WHERE ten_tai_khoan LIKE '%".mb_strtolower($_POST['keyword'],'UTF-8')."%'";

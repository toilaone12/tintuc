...
<body>
    ...
    <?php
        ...
        $selectBaiViet = "SELECT * FROM tintuc WHERE the_tu_khoa LIKE '%".$tukhoa."%' ORDER BY id_tin_tuc DESC LIMIT $page,$so_ban_ghi_muon_lay";
        $resultBaiViet = mysqli_query($conn,$selectBaiViet);
        $selectAll = "SELECT * FROM tintuc WHERE the_tu_khoa LIKE '%".$tukhoa."%'"; 
